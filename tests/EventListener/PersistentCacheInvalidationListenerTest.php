...
final class PersistentCacheInvalidationListenerTest extends TestCase
{
    ...
    public function testQueueEnabledDispatchesPerTagRefreshMessages(): void
    {
        ...
        $cache->expects(self::never())->method('markOutputInvalidated');
    ...
    public function testQueueEnabledDedupSentinelSuppressesSecondDispatch(): void
    {
    ...
    public function testQueueDisabledCallsMarkOutputInvalidated(): void
    {
        $object = $this->makeDataObject(42);
        ...
        $cache = $this->createMock(PersistentOutputCacheService::class);
        $cache->expects(self::once())->method('markOutputInvalidated');
    ...
    public function testQueueEnabledAllMalformedPairsFallsBackToWatermark(): void
    {
