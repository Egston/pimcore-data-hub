...
final class StaleHitTest extends KernelTestCase
{
    ...
    {
        $this->warmCacheForGuardedListing();
        $watermarkBefore = (int)(\Pimcore\Cache::load(PersistentOutputCacheService::KEY_LAST_INVALIDATION) ?: 0);
        ...
        $watermarkAfter = (int)(\Pimcore\Cache::load(PersistentOutputCacheService::KEY_LAST_INVALIDATION) ?: 0);
        self::assertSame(
            $watermarkBefore,
            $watermarkAfter,
    ...
    private function bumpInvalidationWatermark(): void
    {
        \Pimcore\Cache::save(
            time() + 60,
            PersistentOutputCacheService::KEY_LAST_INVALIDATION,
